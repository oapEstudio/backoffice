    ...
    MuiCssBaseline: {
      styleOverrides: {
        ...
        '& .MuiInputBase-root.Mui-disabled': {
          ...
          // mantener el color de texto legible en WebKit
          '& .MuiInputBase-input': {
            WebkitTextFillColor: 'rgba(0,0,0,0.7)',
          },
          // borde del outlined cuando está disabled
          '& .MuiOutlinedInput-notchedOutline': {
            borderColor: 'divider',
          },
        },
        // si querés un borde distinto siempre que esté disabled (aunque cambie de variante)
