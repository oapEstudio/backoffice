     ...
     <CustomStack spacing={5} direction='column'  sx={{ marginTop: 10, position: 'fixed'}}>
        <CustomToggle sx={{justifyContent: 'left'}}  label='Pagina con menu?' options={[{label: 'SI',value: true},{label: 'NO',value: false}]} state={hasMenu} setState={setHasMenu} />
            ...
            <CustomBox >
             ...
             <CustomBox >
                <CustomFab  style={{color: 'white', backgroundColor: colors.palette.primary.main}} variant='extended' onClick={handleSave}>
                    <SaveeIcon  style={{marginRight: '0.5rem', color: 'white'}} />
                        Guardar
                </CustomFab>
            </CustomBox>
