...
import { useUpdateDynamicPageProfile } from '../../../../hooks/useUpdateDynamicPageProfile'


interface UpdateDynamicPageProfileProps {
...
export const UpdateDynamicPageProfile: React.FC<UpdateDynamicPageProfileProps> = ({
  open,
  dynamicPageId,
  selectedProfiles,
  leftSeedProfiles,
  ...
  const { update, loading } = useUpdateDynamicPageProfile()
  ...
  const handleSave = handleSubmit(async (data) => {
    try {
      await update(dynamicPageId, { profiles: data.profiles })
...
export default UpdateDynamicPageProfile
